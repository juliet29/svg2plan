from interactive.interfaces import EdgeDetails, SubsurfaceType
...
def are_matching_subsurface_type(subsurface_type, edge_types, relevant_edges:list[EdgeDetails]):
